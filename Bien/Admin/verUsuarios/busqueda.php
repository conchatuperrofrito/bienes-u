<?php
require '../../../conneccion/usuarioCon.php';
$resultado = null;
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        <a href="../../../dashboard/profile/update_profileForCode.php?idDni=' . $row['tadmin_dni'] . '"
class="btn btn-secondary btnEdit actualizarboton"> ACTUALIZAR </a> 
<br> 
<a href="../../../dashboard/profile/deleteUser.php?idDni=' . $row['tadmin_dni'] . '" onclick="return confirm(' . $output['cot1'] . ');"
