...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="Cotizacion/styleIndex.css">
    <link rel="stylesheet" href="Cotizacion/css/index.css">
    <link rel="stylesheet" href="Cotizacion/cssBusquedaDosBoostrap.css">
    <link rel="stylesheet" href="Cotizacion/cssBusquedaBootrap.css">
...
<body>
    ...
    <main>
        <!-- cambiar  -->
        <header><img src="Cotizacion/img/banner.jpg" alt=""></header>
        <style>
            ...
            <div class="og-contianer">
                ...
                <div class="row g-4 cabezerafilter" style="justify-content: space-between;">
                    ...
                    <div class="col-5" style="display: flex; justify-content: space-between;">
                        <select class="" id="optiona" placeholder="ESTADO" style="height: 50px;">
                            <option value="" selected="">todos</option>
                            <option name="Bueno" value="Bueno">BUENO</option>
                            <option name="Malo" value="Malo">MALO</option>
                            <option name="Regular" value="Malo">REGULAR</option>
                        </select>
                        &nbsp;
                        &nbsp;
                        &nbsp;
                        ...
                        <select class="" id="optionb" placeholder="dependencia" style="height: 50px;">
                            ...
                            <option name="E.P. DE EDUCACION INICIAL INTERCULTURAL"
                                value="E.P. DE EDUCACION INICIAL INTERCULTURAL">E.P. DE EDUCACION INICIAL INTERCULTURAL
                            </option>
                        ...
                        &nbsp;
                        &nbsp;
                        <select class="" id="optionc" placeholder="año" style="height: 50px;">
                            <option value="" selected="">todos</option>
                    ...
                    <div class="col-auto">
                        <div class="col-auto">
                            <label for="campo" class="col-form-label">Buscar con coincidencias : </label>
    ...
    <script>
        ...
        //es la obtencion de change a mostrar de la lista optionc
    ...
    <img id="imagen-carga" src="Cotizacion/Loading_2.gif" alt="Cargando...">
