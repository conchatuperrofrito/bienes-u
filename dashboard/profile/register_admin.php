...
<body>
   ...
   <section class="form-container">
      ...
      <form id="miFormulario" action="" method="post" onsubmit="return validarFormulario()">
         ...
         <input type="text" name="name" required placeholder="ingrese su nombre" maxlength="80" class="box">
         ...
         <input type="text" name="correo" required placeholder="ingresa tu correo" maxlength="80" class="box">
         <h1 class="nombresUpdate">CONTRASEÑA</h1>
         <input type="password" name="pass" required placeholder="Ingrese una contraseña" maxlength="80" class="box"
            oninput="this.value = this.value.replace(/\s/g, '')">
         <input type="password" name="cpass" required placeholder="confirma su contraseña" maxlength="80" class="box"
            oninput="this.value = this.value.replace(/\s/g, '')">
